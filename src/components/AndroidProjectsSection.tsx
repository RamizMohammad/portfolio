...
const projects = [
  ...
  },
  {
    ...
    screenshot: "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=600&h=400&fit=crop",
    icon: "🚗",
    year: "2023",
    color: "216 100% 50%",
  ...
  },
  {
    ...
    screenshot: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=600&h=400&fit=crop",
    icon: "📦",
    year: "2021",
    color: "216 100% 50%",
    ...
    <section id="android-projects" className="section-padding relative z-10 min-h-[100svh] flex flex-col justify-center" ref={sectionRef}>
      <div className="max-w-6xl mx-auto w-full flex flex-col gap-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7 }}>
          ...
          <p className="text-muted-foreground mt-2 max-w-lg text-sm">Tap any card to explore the full story behind each project.</p>
        </motion.div>
                  ...
                  <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <motion.div className="flex-1 flex flex-col gap-5" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.15 }}>
                      ...
                      <motion.div className="flex gap-3 pt-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}>
                        ...
                        {ep.playStore && (
                          <a href={ep.playStore} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 rounded-xl btn-premium px-5 py-2.5 text-sm" onClick={(e) => e.stopPropagation()}>
                ...
                >
                  ...
                  <div className="relative h-[180px] md:h-[200px] overflow-hidden">
                    ...
                    <motion.div
                      ...
                      style={{ background: `linear-gradient(90deg, hsl(${project.color}), hsl(${project.color} / 0.3))` }}
