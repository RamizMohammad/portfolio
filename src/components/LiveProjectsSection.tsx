    ...
    <section className="section-padding relative z-10">
      <div className="max-w-5xl mx-auto">
        <motion.div
          ...
          className="mb-10"
        >
          <p className="text-primary font-display font-medium mb-2">Live Projects</p>
          <h2 className="font-display text-3xl md:text-4xl font-bold">
            My <span className="text-gradient">Deployed</span> Apps
          </h2>
          <p className="text-muted-foreground mt-2">Explore my live, production applications</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {liveProjects.map((project, i) => (
            <motion.a
              ...
              className="group p-6 rounded-2xl bg-card border border-border hover:border-primary/30 transition-all hover:-translate-y-1 block text-center"
            >
              ...
              <h3 className="font-display font-bold group-hover:text-primary transition-colors">{project.name}</h3>
